...
public class EmployeeManagerService {
	    ...
	    public Response insertEmployee(Employee emp) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException {
	    ...
	    public Response insertEmployees(List<Employee> emps) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException {
	    ...
	    public Response deleteEmployee(int empId) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException {
	    ...
	    public Response updateEmployeeSalary(int empId,int salary) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException{
	    ...
	    public Response updateEmployeePhone(int empId,String phone) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException{
	    ...
	    public Response showEmployees(List<Integer> empIds) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException {
	    ...
	    public Response getEmployeesByDept(String dept) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException{
	    ...
	    public Response countOfEmployeesInDept(String dept) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException{
	    	
	    	DatabaseAccessObject dao=new DatabaseAccessObject();
	    	
	    	int count=dao.countOfEmployeesInDept(dept);
	    	
	    	return new Response(true,"count of employees in "+dept+": ",count); 
	    	
	    }
	    
	    public Response getEmployeesWithinSalaryRange(int sal1,int sal2) throws SQLException, FileNotFoundException, IOException, ClassNotFoundException{
	    	
	    	DatabaseAccessObject dao=new DatabaseAccessObject();
	    	
	    	dao.getEmployeesWithinSalaryRange(sal1,sal2);
